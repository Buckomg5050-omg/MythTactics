    ...
    public void SetHighlight(TileHighlightState newState)
    {
        ...
        if (_spriteRenderer != null)
        {
            ...
            switch (newState)
            {
                ...
                // MODIFIED: AbilityRange color changed to yellow
                case TileHighlightState.AbilityRange: _spriteRenderer.color = new Color(1f, 0.92f, 0.016f, 0.75f); break; // Yellow (similar to gold/bright yellow, distinct from Hovered if possible)
